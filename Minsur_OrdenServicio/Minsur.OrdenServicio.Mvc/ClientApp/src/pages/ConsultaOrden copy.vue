...
export default {
    ...
    data(){
        ...
        numeroSolicitud: 'SOL000000001',
        fuenteContratoDto: { descripcion: 'Contrato de Servicios' },
        proyectoDto: { descripcion: 'B2' },
        areaFuncionalDto: { descripcion: 'CONTROL DE PROYECTOS' },
        fechaSolicitud: '2024-01-09',
        estadoDto: { nombre: 'EN PROCESO' }, // Estado en proceso
        usuarioSolicitudDto: { nombreApellido: 'CRISANTO HENRY LLAIQUI LEON' },
        usuarioRevision: 'Ana García',
        idSolicitudOrdenServicio: 1
      },],
            total: 0,
            paginaActual:0,
            nroFilasPorPagina: 0
    ...
    methods: {
        ...
        mostrarDetalleSolicitud(item){
            ...
            this.idSolicitudOrdenServicio = 59;
