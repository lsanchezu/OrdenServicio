          ...
          <div class="col-lg-8">
            <div class="form-group">
              ...
              <input
                type="text"
                name="descripcion"
                v-model="mantenimiento.compania.descripcion"
                class="form-control"
              />
            </div>
          </div>
          <div class="col-lg-4">
            <div class="form-group">
              ...
              <select
                name="estado"
                class="form-control"
                v-model="mantenimiento.compania.idEstado"
              >
                <option
                  v-for="item in mantenimiento.listaEstados"
...
export default {
  ...
  methods: {
    ...
    guardar() {
      this.$emit("guardar", this.mantenimiento.compania);
    }
  }
}
</script>